// 08.01.vector_of_types.cpp : 콘솔 응용 프로그램에 대한 진입점을 정의합니다.
//

#include "stdafx.h"

#include <boost/mpl/aux_/na.hpp>
// boost::mpl::na == n.a. == 는 쓸 수 없다
template <
...
// 이게 없으면 
// 정의된 적 없는 'non_declared' 사용이라는 오류 발생
struct non_declared {};
